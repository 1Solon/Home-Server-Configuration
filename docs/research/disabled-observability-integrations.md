...
_Correction: Wave 2 live validation showed that Immich Metrics Production was not enabled. The deployment uses the obsolete `IMMICH_METRICS_INCLUDE` variable; pinned Immich documentation requires `IMMICH_TELEMETRY_INCLUDE`._
